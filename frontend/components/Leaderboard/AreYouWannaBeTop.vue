        ...
        <div class="item">
            ...
            <div class="item-footer">
                ...
                <p v-if="subscriptionStatus !== null" class="status-message">
                    {{ subscriptionStatus ? "Вы подписаны! +300 очков" : "Вы не подписаны" }}
                </p>
            </div>
        </div>
        <div class="item">
            <div class="item-header">
                ...
                <div class="item-header-content">
                    <div class="item-header-content-title">Друзья</div>
                    <div class="item-header-content-description">Приглашай и добавляй друзей, чтобы попасть в Топ-10
                    </div>
                </div>
            </div>

            <div class="item-footer">
                <button @click="inviteFriend"><span>Пригласить</span></button>
                <p>+50 очков за каждого друга</p>
            </div>
        </div>
    </div>
</template>
