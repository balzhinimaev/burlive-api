...
export default async function greeting(ctx: rlhubContext) {
    ...
    try {
        ...
        let left = 1000000 - confirmed.length



        let message = `<b>Перевод предложений 🚀</b> \n\n`
        message += `Наша цель собрать 1 000 000 переводов предложений из разных сфер жизни, для создания машинного-бурятского языка\n\n`
