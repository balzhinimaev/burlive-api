// src/models/Vocabulary/__mocks__/AcceptedWordRussian.ts
// Этот файл почти полностью повторяет AcceptedWordBuryat.ts,
// так как структура мока для Mongoose модели одинакова.
...
// Главное отличие - имя экспортируемой переменной
const AcceptedWordRussian = {
...
export default AcceptedWordRussian; // Экспортируем мок под правильным именем
