...
if (
    ...
    console.error(
        'YOOKASSA_SHOP_ID и YOOKASSA_SECRET_KEY должны быть установлены в переменных окружения.',
    );
    process.exit(1);
} else if (
    ...
    console.error(
        'YOOKASSA_SHOP_ID_DEV и YOOKASSA_SECRET_KEY_DEV должны быть установлены в переменных окружения.',
    );
    process.exit(1);
}
